                ...
                <Carousel.Caption className='h-100 pb-0'>
                    <div className="row h-100">
                        <div className='col-xl-7 d-flex flex-column align-items-center align-items-md-start justify-content-center mt-5'>
                            ...
                            <h1 className='text-capitalize fw-bold text-center text-md-start'>Wausaukee Club</h1>
                            <p className='mb-4 text-center text-md-start'>Welcome to Wausaukee Club, the perfect experience for special people. Our fancy restaurant will bring your special moments to another level.</p>
